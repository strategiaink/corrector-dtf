...
# CSS Look Novage con visor mejorado
st.markdown("""
    <style>
    ...
    /* Fondo de transparencia tipo Photoshop */
    .leaflet-container {
...
# SIDEBAR
st.sidebar.title("CORRECTOR STRATEGIA")
...
if archivo:
    ...
    # Crear el visor con corrección de error de CRS
    m = folium.Map(
    ...
    # Renderizar visor a ancho completo
